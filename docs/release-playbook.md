...
Use the following commands for the v2.7.0 release tag:
...
```bash
gh release view v2.7.0 --json name,tagName,assets
gh release download v2.7.0 --pattern "checksums-*.txt"
```
