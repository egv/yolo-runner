...
Use the following commands for the v2.4.2 release tag:
...
```bash
gh release view v2.4.2 --json name,tagName,assets
gh release download v2.4.2 --pattern "checksums-*.txt"
```
