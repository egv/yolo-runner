...
func TestReleasePlaybookExistsForV2_7_0(t *testing.T) {
...
func TestMakefileDefinesReleaseV270Target(t *testing.T) {
	...
	if !strings.Contains(makefile, "release-v2.7.0:") {
		t.Fatalf("Makefile missing release-v2.7.0 target")
	}
	required := []string{
		"git status --short",
		"go test ./...",
